...
func (p *Plugin) processSovereignAttestation(ctx context.Context, spiffeID string, publicKey []byte, keySource string, isAgent bool) (*types.AegisAttestedClaims, []byte, error) {
	...
	claims := &types.AegisAttestedClaims{
...
func buildLocalWorkloadClaims(sa *types.AegisSovereignAttestation, spiffeID string, keySource string) ([]byte, error) {
